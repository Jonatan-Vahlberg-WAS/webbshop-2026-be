...
async function seedUser(){
  ...
  const toInsert = usersFromFile.map(u => ({_id: u._id, name: u.name, email: u.email, password: u.password, resetPasswordCode: u.resetPasswordCode, role: u.role, location: u.location, plants: u.plants, history: u.history }))//slug: u.slug
...
async function seedTrades(){
  ...
  const toInsert = tradesFromFile.map(t => ({_id: t._id, plantId: t.plantId, requesterId: t.requesterId, ownerId: t.ownerId, status: t.status }))//slug: u.slug
